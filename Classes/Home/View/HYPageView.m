...
- (UIView *)statusBarView{
    ...
    if (!_statusBarView) {
        ...
        _statusBarView=[[UIView alloc]initWithFrame:CGRectMake(0,0, statwidth, -statheight)];
        _statusBarView.backgroundColor=HWColor(236, 86, 62);
    }
...
- (UIScrollView *)topTabScrollView{
    if (!_topTabScrollView){
       ...
       _topTabScrollView.backgroundColor = HWColor(236, 82, 68);
...
//        
//        [_topTabScrollView addSubview:statusBarView];
